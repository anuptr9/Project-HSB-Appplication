...
public class RoomTypeController {
	...
	@PostMapping("/post")
	public ResponseEntity<UserRoomType> addRoomType(@RequestBody UserRoomType admtype) {
		UserRoomType saveRoomType=typeService.addRoomType(admtype);
		return new ResponseEntity<>(saveRoomType, HttpStatus.CREATED);
	}
	
	@GetMapping("/get")
	public ResponseEntity<List<UserRoomType>> getAllRoomTypes() {
		return new ResponseEntity<List<UserRoomType>>((List<UserRoomType>)typeService.getAllRoomTypes(), HttpStatus.OK);
	}
	...
	@PutMapping("/put")
	public UserRoomType updateLocation(@RequestBody UserRoomType admtype)
	{
